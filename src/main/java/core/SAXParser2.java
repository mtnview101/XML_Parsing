...
SAXParserFactory f = SAXParserFactory.newInstance(); // Create a "parser factory" for creating SAX parsers
SAXParser p = f.newSAXParser(); // Now use the parser factory to create a SAXParser object

DefaultHandler h = new DefaultHandler() { // Create an instance of this DefaultHandler class; it defines all the handler methods
...
if (handler_01) {System.out.println("Key: \t\t " + new String(ch, start, length)); handler_01 = false;}
...
if (handler_04) {System.out.println("Response: \t " + new String(ch, start, length)); handler_04 = false;}
